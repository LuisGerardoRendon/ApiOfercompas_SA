...
class Oferta(Publicacion):
    ...
    def convertir_a_json(self) -> dict:
        ...
        diccionario["imagen"] = "http://192.168.100.10:5000/publicaciones/" + str(self.idPublicacion) + "/imagenes"
        diccionario["video"] = "http://192.168.100.10:5000/publicaciones/" + str(self.idPublicacion) + "/videos"
        return diccionario
