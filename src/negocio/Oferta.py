...
class Oferta(Publicacion):
    ...
    def convertir_a_json(self) -> dict:
        ...
        diccionario["imagen"] = "http://127.0.0.1:4000/publicaciones/" + str(self.idPublicacion) + "/imagenes"
        diccionario["video"] = "http://127.0.0.1:4000/publicaciones/" + str(self.idPublicacion) + "/videos"
        return diccionario
