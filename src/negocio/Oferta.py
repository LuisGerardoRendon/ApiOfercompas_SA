...
class Oferta(Publicacion):
    ...
    def convertir_a_json(self) -> dict:
        ...
        diccionario["imagen"] = "http://0.0.0.0:5000/publicaciones/" + str(self.idPublicacion) + "/imagenes"
        diccionario["video"] = "http://0.0.0.0:5000/publicaciones/" + str(self.idPublicacion) + "/videos"
        return diccionario
